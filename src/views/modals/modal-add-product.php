<div id="modal-add-product">
    <form class="form-group" action="../../controllers/productsController.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <input type="text" class="form-control" id="productName1" name="productName" placeholder="Product Name">
        ...
        <textarea class="form-control" id="productDescription1" name="productDescription" rows="3"></textarea>
        <label for="productPrice">Precio:</label>
        <input type="number" class="form-control" id="productPrice1" name="productPrice" placeholder="Product Price">
